    ...
    <div class="main-container d-flex">
        <div class="sidebar shadow" id="side_nav">
            ...
            <ul class="list-unstyled px-2">
                <li class=""><a href="../admin.html" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-home"></i> Dashboard</a></li>
                <li class=""><a href="view.html" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-list"></i> View Feedback</a></li>
            </ul>
